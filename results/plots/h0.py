...
axs[1,0].axhspan(sh0es[0]-sh0es[1], sh0es[0]+sh0es[1], color='C1')
axs[1,0].axhspan(planck[0]-planck[1], planck[0]+planck[1], color='C2')

axs[1,1].axhspan(sh0es[0]-sh0es[1], sh0es[0]+sh0es[1], color='C1')
axs[1,1].axhspan(planck[0]-planck[1], planck[0]+planck[1], color='C2')
axs[0,1].legend(
